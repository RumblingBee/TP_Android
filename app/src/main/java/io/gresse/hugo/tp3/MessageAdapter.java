...
if(viewType==TYPE_RECEIVED) {
   view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_messages, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        RelativeTimeTextView mTimestampView;
        ...
        ViewHolder(View itemView) {
            ...
            mTimestampView = (RelativeTimeTextView)itemView.findViewById(R.id.timestamp); //Or just use Butterknife!
        ...
        void setData(Message message) {
            ...
            mTimestampView.setReferenceTime(message.timestamp);
    ...
    public interface Listener {
        ...
        void onLongClick(int position, Message message);
